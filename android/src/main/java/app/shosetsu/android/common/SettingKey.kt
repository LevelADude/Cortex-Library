...
sealed class SettingKey<T : Any>(val name: String, val default: T) {
	...
	object ReaderStylePresetsJson : StringKey("reader_style_presets_json_v1", "")
	object ReaderStyleActivePresetId : StringKey("reader_style_active_preset_id", "builtin:classic")
	object ReaderLibraryFontMetadataJson : StringKey("reader_library_font_metadata_json_v1", "")
	object ReaderLibraryFontCatalogCacheJson : StringKey("reader_library_font_catalog_cache_json_v1", "")
	...
	object AppTheme : IntKey("selectedAppTheme", 3)
	object CustomThemeEnabled : BooleanKey("custom_theme_enabled", false)
	object CustomThemeBackground : StringKey("custom_theme_background", "")
	object CustomThemeSurface : StringKey("custom_theme_surface", "")
	object CustomThemePrimary : StringKey("custom_theme_primary", "")
	object CustomThemeOnPrimary : StringKey("custom_theme_onPrimary", "")
	object CustomThemeOnBackground : StringKey("custom_theme_onBackground", "")
	object CustomThemeIconTint : StringKey("custom_theme_iconTint", "")
	object CustomThemeNavSelected : StringKey("custom_theme_navSelected", "")
	object CustomThemeTopBarContainer : StringKey("custom_theme_topBarContainer", "")
	object CustomThemeBottomBarContainer : StringKey("custom_theme_bottomBarContainer", "")
	object CustomThemeBottomBarSelected : StringKey("custom_theme_bottomBarSelected", "")
