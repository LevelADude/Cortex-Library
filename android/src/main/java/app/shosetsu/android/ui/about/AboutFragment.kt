...
fun AboutContent(
	...
	LazyColumn(
		...
		item {
			AboutItem(
				R.string.website,
				descriptionRes = R.string.about_link_website_desc,
		...
		item {
			AboutItem(
				R.string.github,
				descriptionRes = R.string.about_link_source_desc,
		...
		item {
			AboutItem(
				R.string.extensions,
				descriptionRes = R.string.about_link_extensions_desc,
		...
		item {
			AboutItem(
				R.string.matrix,
				descriptionRes = R.string.about_link_matrix_desc,
		...
		item {
			AboutItem(
				R.string.discord,
				descriptionRes = R.string.about_link_discord_desc,
		...
		item {
			AboutItem(
				R.string.disclaimer,
				descriptionRes = R.string.about_link_disclaimer_desc,
