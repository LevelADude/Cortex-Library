...
class ChapterReaderViewModel(
	...
	private val readerStyleRepository: IReaderStyleRepository,
	...
	override val activeReaderStyle by lazy {
		readerStyleRepository.activePresetFlow.onIO().stateIn(viewModelScopeIO, SharingStarted.Lazily, app.shosetsu.android.domain.model.reader.builtInReaderStylePresets().first())
	}
